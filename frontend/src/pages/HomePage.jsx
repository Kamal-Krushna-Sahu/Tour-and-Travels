...
const HomePage = () => {
  return (
    <>
      <div className="px-4 py-3 bg-gradient-to-b from-blue-300 to-blue-400 md:to-blue-500 md:h-max">
        <div className="flex flex-col gap-2 md:w-9/12 m-auto">
          ...
          <div className="flex flex-col gap-2 md:flex-row md:mb-5">
            <p className="text-white md:text-2xl text-center font-bold md:w-2/3 md:mt-10">
              ...
              Vidyalaya. We are fully-insured. Our trained driver will ensure
              your child's daily commute is safe, reliable, and comfortable.
            </p>
          ...
          <div>
            <p className="text-white md:text-xl text-center">
              ...
              <br />
              <b>Flexible Scheduling:</b> Morning and afternoon shifts aligned
              to school timings.
              <br />
              <br />
